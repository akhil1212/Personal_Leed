...
def static "leedOnlineKeywords.projectKeywords.clickCheckbox"(
    	String xpath	
     , 	String iframe	) {
    (new leedOnlineKeywords.projectKeywords()).clickCheckbox(
        	xpath
         , 	iframe)
}

def static "leedOnlineKeywords.projectKeywords.countRowsPerTable"(
    	String xpath	
     , 	String iframe	) {
    (new leedOnlineKeywords.projectKeywords()).countRowsPerTable(
        	xpath
         , 	iframe)
}
...
def static "leedOnlineKeywords.projectKeywords.changeTheUnits"(
    	String unitType	
     , 	String formname	
     , 	String spanV01	) {
    (new leedOnlineKeywords.projectKeywords()).changeTheUnits(
        	unitType
         , 	formname
         , 	spanV01)
}
