...
class RM_Download_Files {
	/**
	 * Downloading and verifying the uploaded files in the form -- Started
	 */
	...
	public void user_downloads_the_uploaded_files_of_rainfall_events_calculator_or_equivalent_documentation() {
	...
	public void user_can_see_the_downloaded_file_of_rainfall_events_calculator_or_equivalent_documentation() {

		new projectKeywords().verifyDownloadedFiles()
	}

	@When("User downloads the uploaded files of calculations of impervious surfaces")
	public void user_downloads_the_uploaded_files_of_calculations_of_impervious_surfaces() {
	...
	public void user_can_see_the_downloaded_file_of_calculations_of_impervious_surfaces() {

		new projectKeywords().verifyDownloadedFiles()
	}

	@When("User downloads the uploaded files of documents that thoroughly depict the green infrastructure techniques used")
	public void user_downloads_the_uploaded_files_of_documents_that_thoroughly_depict_the_green_infrastructure_techniques_used() {
	...
	public void user_can_see_the_downloaded_file_of_documents_that_thoroughly_depict_the_green_infrastructure_techniques_used() {

		new projectKeywords().verifyDownloadedFiles()
	}

	@When("User downloads the uploaded files of document or narrative describing the annual inspection and maintenance program")
	public void user_downloads_the_uploaded_files_of_document_or_narrative_describing_the_annual_inspection_and_maintenance_program() {
	...
	public void user_can_see_the_downloaded_file_of_document_or_narrative_describing_the_annual_inspection_and_maintenance_program() {

		new projectKeywords().verifyDownloadedFiles()
	}

	@When("User downloads the uploaded files of additional documents in special circumstances in Rainwater Management")
	public void user_downloads_the_uploaded_files_of_additional_documents_in_special_circumstances_in_Rainwater_Management() {
	...
	public void user_can_see_the_downloaded_file_of_additional_documents_in_special_circumstances_in_Rainwater_Management() {

		new projectKeywords().verifyDownloadedFiles()
	}

	/**
	 * Downloading and verifying the uploaded files in the form -- Ended
	 */
}