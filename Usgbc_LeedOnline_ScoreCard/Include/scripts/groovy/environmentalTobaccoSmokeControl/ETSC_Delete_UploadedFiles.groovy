...
class ETSC_Delete_UploadedFiles {
	...
	public void user_can_see_all_the_No_smoking_policy_document_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_NonSmokePolicy/table_NonSmoke'), 30)
	}


	@When("User deletes the uploaded files of scaled site plan")
	public void user_deletes_the_uploaded_files_of_scaled_site_plan() {
	...
	public void user_can_see_all_the_scaled_site_plan_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_ScaledSite/table_ScaledSite'), 30)
	}


	@When("User deletes the uploaded files of information about the code")
	public void user_deletes_the_uploaded_files_of_information_about_the_code() {
	...
	public void user_can_see_all_the_information_about_the_code_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_InformationCode/table_InfoCode'), 30)
	}

	@When("User deletes the uploaded files of weather stripping and sealing")
	public void user_deletes_the_uploaded_files_of_weather_stripping_and_sealing() {
	...
	public void user_can_see_all_the_weather_stripping_and_sealing_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_WeatherStripping/table_WeatherStrip'), 30)
	}

	@When("User deletes the uploaded files of differential air pressure test report")
	public void user_deletes_the_uploaded_files_of_differential_air_pressure_test_report() {
	...
	public void user_can_see_all_the_differential_air_pressure_test_report_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_AirPressure/table_AirPressure'), 30)
	}

	@When("User deletes the uploaded files of special circumstances in Environmental Tobacco Smoke Control")
	public void user_deletes_the_uploaded_files_of_special_circumstances_in_Environmental_Tobacco_Smoke_Control() {
	...
	public void user_can_see_all_the_special_circumstances_in_Environmental_Tobacco_Smoke_Control_files_are_deleted() {

		WebUI.delay(2)
		WebUI.verifyElementNotPresent(findTestObject('Object Repository/EnvironmentalTobaccoSmokeControl/AddFile_SpecialCircum/table_SplCircum'), 30)
	}
