...
class ERM_DownloadedFiles {
	...
	public void user_downloads_the_uploaded_files_of_refrigerant_equipment_schedule_in_ERM_Form() {
		...
		new projectKeywords().downloadUploadedFiles(tableRow,tableId,scrollTo,ERM_Entities.iframe)
	}

	@Then("User can see the downloaded file of refrigerant equipment schedule in ERM Form successfully")
	public void user_can_see_the_downloaded_file_of_refrigerant_equipment_schedule_in_ERM_Form_successfully() {

		new projectKeywords().verifyDownloadedFiles()
	}

	@When("User downloads the uploaded files of additional documentation in ERM Form")
	public void user_downloads_the_uploaded_files_of_additional_documentation_in_ERM_Form() {
	...
	public void user_can_see_the_downloaded_file_of_additional_documentation_in_ERM_Form() {
