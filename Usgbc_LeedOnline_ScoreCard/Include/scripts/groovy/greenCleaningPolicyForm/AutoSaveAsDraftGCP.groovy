...
class AutoSaveAsDraftGCP {
	...
	//------------
	@Given("User should be able to see the textbox in Green Cleaning Policy Form")
	public void user_should_be_able_to_see_the_textbox_in_Green_Cleaning_Policy_form() {

		boolean txt_Percent = WebUI.verifyElementPresent(findTestObject('Object Repository/GreenCleaningPolicy/Option2_CertifiedCleanService/TextBox_Option2/input_TextBox_GreenCleaningService'), 30)
		println "The text is present or not "+txt_Percent
	}

	static String txt_dataGCP
	@When("User modifies the textbox value in the Green Cleaning Policy Form and waits for 10 seconds")
	public void user_modifies_the_textbox_value_in_the_Green_Cleaning_Policy_form_and_waits_for_seconds() {
		txt_dataGCP = "Checking the text box for auto save as draft with date and time 0877667"
	...
	public void user_can_see_the_draft_is_saved_automatically_with_date_and_time_for_change_in_textbox_in_Green_Cleaning_Policy_form() {
		...
		textBox_draft = WebUI.getText(findTestObject('Object Repository/GreenCleaningPolicy/span_Last draft saved on'))
	...
	public void user_should_not_see_saving_of_draft_even_after_seconds_in_GCP() {
		...
		println "Save Date and Time Before:"+textBox_draft

		println "Save Date and Time After:"+draft_time

		WebUI.verifyMatch(textBox_draft, draft_time,false)
	...
	public void user_verifies_the_form_draft_warning_message_is_not_retained_in_Green_Cleaning_Policy_form() {
		...
		String tableRow1 = "Object Repository/GreenCleaningPolicy/Option2_CertifiedCleanService/AddFile_UploadInfoShowingContract_Option2/tbody_Table_ShowingContract"
	...
	@Given("User can see the radio button in Green Cleaning Policy form for In-house green cleaning policy")
	public void user_can_see_the_radio_button_in_Green_Cleaning_Policy_form_for_Certified_cleaning_service() {

		WebUI.verifyElementPresent(findTestObject('Object Repository/GreenCleaningPolicy/Option1_GreenCleanPlcy/input_Option1_Radiobtn'), 30)
	}

	@When("User clicks on the radio button of In-house green cleaning policy and waits for 10 seconds")
	public void user_clicks_on_the_radio_button_of_In_house_green_cleaning_policy_and_waits_for_10_seconds() {
		WebUI.scrollToElement(findTestObject('Object Repository/GreenCleaningPolicy/Option1_GreenCleanPlcy/input_Option1_Radiobtn'), 10)
