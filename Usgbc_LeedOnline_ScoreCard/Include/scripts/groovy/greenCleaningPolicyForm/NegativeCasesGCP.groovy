...
class NegativeCasesGCP {
	...
	public void user_clicks_on_save_while_the_file_is_uploading_in_GCP() {
		...
		WebUI.scrollToElement(findTestObject("Object Repository/GreenCleaningPolicy/btn_Save"), 30)
		WebUI.click(findTestObject("Object Repository/GreenCleaningPolicy/btn_Save"))
	}
